...
@section('header-css')
    <link rel='stylesheet' id='onepress-bootstrap-css'  href="{{ asset('css/front/bootstrap.min.css?ver=2.2.4') }}" media='all' />
    <link rel="stylesheet" type="text/css" href="{{ asset('css/front/order-review.css') }}">
@endsection
...
@section('body')
    ...
    <div class="row">
        <div class="col-md-6 offset-3">
            ...
            <hr>
            <form action="{{ route('review-insert', $order_id) }}" method="POST">
                @csrf
