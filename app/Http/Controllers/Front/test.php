...
<script type='text/javascript' src='js/bootstrap-5.2.4.min.js'></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBzC94pnwIAUI5G3HQKxFCnFBiDiHIIfJk"></script>
<script>
...
function abc(){
	...
	locations.eachLayer(function(locale) {
	    ...
	    var city = prop.city;
	    link.href = 'luggage-storage.php?city='+city;
